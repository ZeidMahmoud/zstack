...
export interface EnsureDaemonOptions {
   ...
   * DESIGN_DAEMON_STATE_FILE or .zstack/design.json under the git root /
    ...
    if (health) {
      ...
      if (health.activeBoards > 0) {
        process.stderr.write(
          `[design-daemon] WARNING: existing daemon is zstack ${health.version}; this CLI is ${expectedVersion}.\n` +
