...
<title>Cookie Import — zstack browse</title>
<style>
...
<p class="subtitle">Select the domains of cookies you want to import to ZStack Browser. You'll be able to browse those sites with the same login as your other browser.</p>
