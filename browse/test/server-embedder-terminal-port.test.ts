...
// getting those files clobbered by zstack's shutdown(). The flag (default true)
...
// False = embedder owns them, zstack stays hands-off.
//
// Pre-v1.44 used `pkill -f terminal-agent\.ts` which matched sibling zstack
