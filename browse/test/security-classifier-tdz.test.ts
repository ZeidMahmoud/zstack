...
describe('security-classifier: missing claude CLI degraded path', () => {
  ...
  afterEach(() => {
    ...
    if (origZstackClaudeBin !== undefined) process.env.ZSTACK_CLAUDE_BIN = origZstackClaudeBin;
