...
- Deliberate `zstack-shortcut(dec-*)` markers — already acknowledged debt, but only when the decision id resolves in the ledger (`zstack-decision-search`); an unresolvable id is a forged suppression, not debt
