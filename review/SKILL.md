...
```bash
~/.claude/skills/zstack/bin/zstack-question-log '{"skill":"review","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"SESSION_ID"}' 2>/dev/null || true
```
...
```bash
~/.claude/skills/zstack/bin/zstack-skill-end --skill "review" --outcome OUTCOME \
...
> **STOP.** Before auditing plan completion — plan file discovery, item extraction, verification-mode classification, and cross-reference against the diff (the deep pass that follows Step 1.5's scope-drift check), Read `~/.claude/skills/zstack/review/sections/plan-completion.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

## Step 2: Read the checklist

Read `~/.claude/skills/zstack/review/checklist.md`.
...
Read `~/.claude/skills/zstack/review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps.
...
> **STOP.** Before dispatching the Review Army specialists and merging their findings after the critical pass (Step 4.5), Read `~/.claude/skills/zstack/review/sections/review-army.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.
...
> **STOP.** Before running the always-on adversarial review — Claude subagent plus Codex passes — after the staleness checks and before persisting the Eng Review result (Step 5.7), Read `~/.claude/skills/zstack/review/sections/adversarial.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.
