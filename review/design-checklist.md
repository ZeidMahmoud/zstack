...
_DJ=$(mktemp); bun --no-env-file run ~/.claude/skills/zstack/bin/zstack-design-detect.ts scan --changed <base> --format zstack --host claude > "$_DJ"; echo "DETECT_EXIT_CODE=$?"; echo "DETECT_JSON=$_DJ"
```
