// Allowlist file at ~/.zstack/ios-qa-allowlist.json. The single source of
...
export function defaultAllowlistPath(): string {
  return process.env.ZSTACK_IOS_ALLOWLIST_PATH
    ?? join(homedir(), '.zstack', 'ios-qa-allowlist.json');
}
