...
describe('daemon — tailnet listener (mocked tailscaled)', () => {
  ...
  beforeEach(async () => {
    ...
    process.env.ZSTACK_IOS_ALLOWLIST_PATH = listPath;
    ...
    process.env.ZSTACK_IOS_TAILNET_BIND = '127.0.0.1'; // safe test bind
  ...
  test('audit log records mutating tailnet requests', async () => {
    ...
    const auditPath = process.env.ZSTACK_IOS_AUDIT_PATH!;
