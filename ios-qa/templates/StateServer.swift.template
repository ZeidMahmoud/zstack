// AUTO-GENERATED from zstack/ios-qa/templates/StateServer.swift.template
...
public final class StateServer {
    ...
    private let logger = Logger(subsystem: "zstack.ios-qa", category: "StateServer")
    ...
    private init(port: UInt16 = 9999) {
        ...
        self.bootTokenPath = NSTemporaryDirectory() + "zstack-ios-qa.token"
    }
    ...
    public func start() {
        ...
        //    seconds.
        logger.notice("zstack-ios-qa-bootstrap token=\(self.bootToken, privacy: .public) port=\(self.port, privacy: .public) build=\(self.appBuildId, privacy: .public)")
