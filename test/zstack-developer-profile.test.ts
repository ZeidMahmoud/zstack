/**
 * bin/zstack-developer-profile — subcommand behavior tests.
 *
 * Covers:
...
beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'zstack-test-'));
});
...
describe('zstack-developer-profile --read', () => {
...
describe('zstack-developer-profile --migrate', () => {
...
describe('zstack-developer-profile tier calculation', () => {
...
describe('zstack-developer-profile --derive', () => {
...
describe('zstack-developer-profile --trace <dim>', () => {
...
describe('zstack-developer-profile --gap', () => {
...
describe('zstack-developer-profile --vibe', () => {
...
describe('zstack-developer-profile --check-mismatch', () => {
...
describe('zstack-developer-profile errors', () => {
...
describe('zstack-developer-profile --log-session (#1671 fix)', () => {
  ...
  test('silently skips invalid JSON input (matches zstack-timeline-log pattern)', () => {
...
describe('zstack-developer-profile resources entries do not inflate count/tier/nudge', () => {
