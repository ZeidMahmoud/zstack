...
- Save the report to .zstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.zstack', 'security-reports');
...
- Skip the preamble (zstack-update-check, telemetry, etc.) — go straight to the audit.
