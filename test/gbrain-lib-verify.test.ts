/**
 * zstack-gbrain-supabase-verify + zstack-gbrain-lib.sh — Slice 3 of /setup-gbrain.
 *
 ...
 * skill template and by zstack-gbrain-supabase-provision. Validates var
...
const VERIFY = path.join(ROOT, 'bin', 'zstack-gbrain-supabase-verify');
...
describe('zstack-gbrain-supabase-verify', () => {
  const VALID =
...
describe('zstack-gbrain-lib.sh read_secret_to_env', () => {
