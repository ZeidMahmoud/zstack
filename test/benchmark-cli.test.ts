/**
 * zstack-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'zstack-model-benchmark');
...
describe('zstack-model-benchmark prompt resolution', () => {
