...
describe('AC routing manual-skills option', () => {
  ...
  test('unrelated product choices and additional Add actions do not borrow routing setup', () => {
    for (const question of [
      'Which product API routing design should we choose? <zstack-qid:routing-injection>',
      'The plan quotes zstack skill routing rules in CLAUDE.md. Should we expand the feature? <zstack-qid:routing-injection>',
    ]) {
