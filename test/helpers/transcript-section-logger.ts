...
export const SHIP_ACTIONS = [
  ...
  'bumped_version',    // wrote VERSION / package.json version / ran zstack-version-bump
...
const BASH_ACTION_PATTERNS: Array<{ action: ShipAction; re: RegExp }> = [
  ...
  { action: 'bumped_version', re: /zstack-version-bump\b|zstack-next-version\b|>\s*VERSION\b|npm\s+version\b/ },
...
const DEFAULT_BASELINE_DIR = path.join(os.homedir(), '.zstack-dev', 'ship-baselines');
