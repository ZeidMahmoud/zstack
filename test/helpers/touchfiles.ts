...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'operational-learning':     ['scripts/resolvers/preamble.ts', 'bin/zstack-learnings-log'],
  ...
  'review-army-migration-safety': ['review/**', 'scripts/resolvers/review-army.ts', 'bin/zstack-diff-scope'],
  'review-army-perf-n-plus-one':  ['review/**', 'scripts/resolvers/review-army.ts', 'bin/zstack-diff-scope'],
  ...
  'auto-decide-preserved':        ['scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completion-status.ts', 'plan-ceo-review/**', 'bin/zstack-question-preference', 'bin/zstack-config', 'bin/zstack-slug', 'test/helpers/claude-pty-runner.ts'],
  ...
  'ship-idempotency-pty':        ['ship/**', 'bin/zstack-next-version', 'bin/zstack-version-bump', 'scripts/resolvers/sections.ts', 'lib/worktree.ts', 'test/helpers/claude-pty-runner.ts'],
  ...
  'brain-privacy-gate':           ['scripts/resolvers/preamble/generate-brain-sync-block.ts', 'scripts/resolvers/preamble.ts', 'bin/zstack-brain-sync', 'bin/zstack-artifacts-init', 'bin/zstack-config', 'test/helpers/agent-sdk-runner.ts'],
  ...
  'setup-gbrain-remote':          ['setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'bin/zstack-artifacts-init', 'bin/zstack-gbrain-detect', 'test/helpers/agent-sdk-runner.ts'],
  'setup-gbrain-bad-token':       ['setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'test/helpers/agent-sdk-runner.ts'],
  ...
  'setup-gbrain-path4-local-pglite': ['setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'bin/zstack-gbrain-install', 'bin/zstack-gbrain-detect', 'lib/gbrain-local-status.ts', 'test/helpers/agent-sdk-runner.ts'],
  ...
  'plan-tune-inspect':         ['plan-tune/**', 'scripts/question-registry.ts', 'scripts/psychographic-signals.ts', 'scripts/one-way-doors.ts', 'bin/zstack-question-log', 'bin/zstack-question-preference', 'bin/zstack-developer-profile'],

  // /plan-tune cathedral (T16 — 5 E2E scenarios, all gate per D12)
  'plan-tune-hook-capture':      ['hosts/claude/hooks/**', 'bin/zstack-question-log', 'bin/zstack-developer-profile', 'plan-tune/**'],
  'plan-tune-enforcement':       ['hosts/claude/hooks/**', 'bin/zstack-question-preference', 'scripts/question-registry.ts'],
  ...
  'plan-tune-codex-import':      ['bin/zstack-codex-session-import', 'bin/zstack-question-log', 'docs/spikes/codex-session-format.md'],
  'plan-tune-dream-cycle':       ['bin/zstack-distill-free-text', 'bin/zstack-distill-apply', 'hosts/claude/hooks/**', 'plan-tune/**'],
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/zstack-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/zstack-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  // Learnings
  'learnings-show': ['learn/**', 'bin/zstack-learnings-search', 'bin/zstack-learnings-log', 'scripts/resolvers/learnings.ts'],

  // Session Intelligence (timeline, context recovery, /context-save + /context-restore)
  'timeline-event-flow':            ['bin/zstack-timeline-log', 'bin/zstack-timeline-read'],
  'context-recovery-artifacts':     ['scripts/resolvers/preamble.ts', 'bin/zstack-timeline-log', 'bin/zstack-slug', 'learn/**'],
  'context-save-writes-file':       ['context-save/**', 'bin/zstack-slug'],
  'context-restore-loads-latest':   ['context-restore/**', 'bin/zstack-slug'],
  ...
  'context-save-then-restore-roundtrip':   ['context-save/**', 'context-restore/**', 'bin/zstack-slug'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/zstack-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/zstack-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/zstack-repo-mode'],
  ...
  // zstack-upgrade
  'zstack-upgrade-happy-path': ['zstack-upgrade/**'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/zstack-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/zstack-review-read'],
  ...
  'autoplan-dual-voice': ['autoplan/**', 'codex/**', 'bin/zstack-codex-probe', 'scripts/resolvers/review.ts', 'scripts/resolvers/design.ts'],

  // Multi-provider benchmark adapters — live API smoke against real claude/codex/gemini CLIs
  'benchmark-providers-live': ['bin/zstack-model-benchmark', 'test/helpers/providers/**', 'test/helpers/benchmark-runner.ts', 'test/helpers/pricing.ts'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // dependency, deterministic). with-device path requires ZSTACK_HAS_IOS_DEVICE.
  'ios-qa-e2e': 'gate',
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'zstack-upgrade/SKILL.md upgrade flow': ['zstack-upgrade/SKILL.md', 'zstack-upgrade/SKILL.md.tmpl'],
