 ...
 * a Conductor worktree named anything but "zstack" would mismatch the fixture
 ...
 */
export const ROOT_SKILL_KEY = 'zstack';
 ...
 * aliases deduped by realpath (connect-chrome -> open-zstack-browser; on
