...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  'shared-libs-review-path-eligibility': ['review/**', 'scripts/resolvers/shared-libs.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/review-army.ts', 'lib/review-evidence.ts', 'bin/zstack-review-log', 'bin/zstack-review-read', 'bin/zstack-wtree', 'test/helpers/shared-libs-eval-fixture.ts', 'test/skill-e2e-shared-libs-paths.test.ts', 'test/helpers/shared-libs-path-fixture.ts', 'test/shared-libs-fixture.test.ts', 'test/helpers/e2e-gate.ts', 'scripts/gen-skill-docs.ts', 'test/helpers/agent-sdk-runner.ts', 'lib/claude-bin.ts', 'lib/eval-model.ts', 'test/fixtures/shared-libs-index-flags-skip-question.json', 'test/shared-libs-revalidation-prompt.test.ts'],
  'shared-libs-review-index-flags': ['review/**', 'scripts/resolvers/shared-libs.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/review-army.ts', 'lib/review-evidence.ts', 'bin/zstack-review-log', 'bin/zstack-review-read', 'bin/zstack-wtree', 'test/helpers/shared-libs-eval-fixture.ts', 'test/skill-e2e-shared-libs-paths.test.ts', 'test/helpers/shared-libs-path-fixture.ts', 'test/shared-libs-fixture.test.ts', 'test/helpers/e2e-gate.ts', 'scripts/gen-skill-docs.ts', 'test/helpers/agent-sdk-runner.ts', 'lib/claude-bin.ts', 'lib/eval-model.ts', 'test/fixtures/shared-libs-index-flags-skip-question.json', 'test/shared-libs-revalidation-prompt.test.ts', 'test/fixtures/shared-libs-paths-max-turns-public.json'],
  'shared-libs-review-prior-coverage': ['review/**', 'scripts/resolvers/shared-libs.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/review-army.ts', 'lib/review-evidence.ts', 'bin/zstack-review-log', 'bin/zstack-review-read', 'bin/zstack-wtree', 'test/helpers/shared-libs-eval-fixture.ts', 'test/skill-e2e-shared-libs-paths.test.ts', 'test/helpers/shared-libs-path-fixture.ts', 'test/shared-libs-fixture.test.ts', 'test/helpers/e2e-gate.ts', 'scripts/gen-skill-docs.ts', 'test/helpers/agent-sdk-runner.ts', 'lib/claude-bin.ts', 'lib/eval-model.ts', 'test/fixtures/shared-libs-index-flags-skip-question.json', 'test/shared-libs-revalidation-prompt.test.ts'],
  ...
  'shared-libs-review-lifecycle': ['deslop-shared-libs/**', 'scripts/resolvers/shared-libs.ts', 'scripts/resolvers/index.ts', 'test/helpers/shared-libs-eval-fixture.ts', 'review/**', 'scripts/resolvers/review.ts', 'scripts/resolvers/review-army.ts', 'lib/review-evidence.ts', 'bin/zstack-review-log', 'bin/zstack-review-read', 'bin/zstack-wtree', 'test/skill-e2e-shared-libs.test.ts', 'test/shared-libs-fixture.test.ts', 'test/helpers/e2e-gate.ts', 'scripts/gen-skill-docs.ts', 'test/helpers/agent-sdk-runner.ts', 'lib/claude-bin.ts', 'lib/eval-model.ts', 'test/fixtures/shared-libs-index-flags-skip-question.json'],
  'shared-libs-review-revalidation': ['deslop-shared-libs/**', 'scripts/resolvers/shared-libs.ts', 'scripts/resolvers/index.ts', 'test/helpers/shared-libs-eval-fixture.ts', 'review/**', 'scripts/resolvers/review.ts', 'scripts/resolvers/review-army.ts', 'lib/review-evidence.ts', 'bin/zstack-review-log', 'bin/zstack-review-read', 'bin/zstack-wtree', 'test/skill-e2e-shared-libs.test.ts', 'test/shared-libs-fixture.test.ts', 'test/helpers/e2e-gate.ts', 'scripts/gen-skill-docs.ts', 'test/helpers/agent-sdk-runner.ts', 'lib/claude-bin.ts', 'lib/eval-model.ts', 'test/helpers/shared-libs-review-start-evidence.ts', 'test/shared-libs-review-start-evidence.test.ts', 'test/fixtures/shared-libs-review-start-public.json', 'test/shared-libs-revalidation-prompt.test.ts', 'test/fixtures/shared-libs-revalidation-max-turns-public.json', 'test/fixtures/shared-libs-index-flags-skip-question.json'],
  ...
  // gate + token→tip map live in bin/zstack-skill-start's emission layer).
  'first-task-scaffold': ['test/session-runner-stream-lifecycle.test.ts', 'bin/zstack-skill-start', 'bin/zstack-skill-end', 'bin/zstack-first-task-detect', 'scripts/resolvers/preamble/generate-preamble-bash.ts', 'test/skill-e2e-first-task-scaffold.test.ts', 'test/helpers/session-runner.ts'],

  // SKILL.md setup + preamble (depend on ROOT SKILL.md + gen-skill-docs)
  'skillmd-setup-discovery':  ['test/session-runner-stream-lifecycle.test.ts', 'SKILL.md', 'SKILL.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-bws.test.ts'],
  'skillmd-no-local-binary':  ['test/session-runner-stream-lifecycle.test.ts', 'SKILL.md', 'SKILL.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-bws.test.ts'],
  'skillmd-outside-git':      ['test/session-runner-stream-lifecycle.test.ts', 'SKILL.md', 'SKILL.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-bws.test.ts'],

  'session-awareness':        ['test/session-runner-stream-lifecycle.test.ts', 'SKILL.md', 'SKILL.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-bws.test.ts'],
  'operational-learning':     ['test/session-runner-stream-lifecycle.test.ts', 'scripts/resolvers/preamble.ts', 'bin/zstack-learnings-log', 'test/skill-e2e-bws.test.ts'],
  ...
  'review-design-lite':       ['test/session-runner-stream-lifecycle.test.ts', 'review/**', 'test/fixtures/review-eval-design-slop.*', 'test/helpers/fake-impeccable.ts', 'test/fixtures/fake-impeccable.ts', 'test/fixtures/impeccable-detect-sample.json', 'lib/design-catalog.ts', 'lib/design-detect-contract.ts', 'bin/zstack-design-detect.ts', 'scripts/resolvers/design-checklist.ts', 'scripts/resolvers/review-army.ts', 'test/skill-e2e-review.test.ts',
    'test/review-finalization-budget.test.ts'
  ],

  // Review Army (specialist dispatch)
  'review-army-migration-safety': ['test/session-runner-stream-lifecycle.test.ts', 'review/**', 'scripts/resolvers/review-army.ts', 'bin/zstack-diff-scope', 'test/skill-e2e-review-army.test.ts'],
  'review-army-perf-n-plus-one':  ['test/session-runner-stream-lifecycle.test.ts', 'review/**', 'scripts/resolvers/review-army.ts', 'bin/zstack-diff-scope', 'test/skill-e2e-review-army.test.ts'],
  ...
  'review-army-simplification':   ['test/session-runner-stream-lifecycle.test.ts', 'review/**', 'scripts/resolvers/review-army.ts', 'test/fixtures/review-army-overbuild.js', 'test/fixtures/review-army-lean-complete.js', 'test/skill-e2e-review-army.test.ts'],
  'review-army-simplification-precision': ['test/session-runner-stream-lifecycle.test.ts', 'review/**', 'scripts/resolvers/review-army.ts', 'test/fixtures/review-army-overbuild.js', 'test/fixtures/review-army-lean-complete.js', 'test/skill-e2e-review-army.test.ts'],
  'review-army-consensus':        ['test/session-runner-stream-lifecycle.test.ts', 'review/**', 'scripts/resolvers/review-army.ts', 'test/skill-e2e-review-army.test.ts', 'test/review-consensus-lifecycle.test.ts',
    'test/review-army-budget.test.ts'
  ],

  // Office Hours
  'office-hours-spec-review':     ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'office-hours/**', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-plan.test.ts',
    'bin/zstack-office-hours-review', 'lib/office-hours-review.ts', 'lib/fs-atomic.ts', 'scripts/resolvers/review.ts', 'test/helpers/skill-fixture.ts', 'test/helpers/office-hours-completion.ts'
  ],
  ...
  // Plan reviews
  'plan-ceo-review':                  ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'test/skill-e2e-plan.test.ts',
    'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  'plan-ceo-review-selective':        ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'test/skill-e2e-plan.test.ts',
    'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  'plan-ceo-review-benefits':         ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-plan.test.ts',
    'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/tasks-section.ts'
  ],
...
'test/paid-retry-supervision.test.ts',
    ...
    'test/auto-decide-saved-ai.test.ts', 'test/fixtures/auto-decide-saved-ai.json', 'test/fixtures/auto-decide-retry-ai.json','bin/zstack-skill-start', 'bin/zstack-skill-end', 'bin/zstack-session-kind', 'scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-preamble-bash.ts', 'scripts/resolvers/preamble/generate-completion-status.ts', 'plan-ceo-review/**', 'bin/zstack-question-preference', 'bin/zstack-config', 'bin/zstack-slug', 'hosts/claude/hooks/question-preference-hook.ts', 'hosts/claude/hooks/spawned-directive.ts', 'lib/is-conductor.ts', 'test/helpers/claude-pty-runner.ts', 'test/plan-count-design-ui-recovery.test.ts', 'test/fixtures/design-ui-boxed-question.json', 'test/helpers/hermetic-skill-runtime.ts', 'test/hermetic-skill-runtime.test.ts', 'test/helpers/pty-trust-dialog.ts', 'test/pty-trust-dialog.test.ts', 'test/skill-e2e-auto-decide-preserved.test.ts', 'test/plan-count-truncated-border.test.ts', 'test/fixtures/eng-d2-truncated-border-0bcd.json', 'test/plan-count-truncated-question.test.ts', 'test/plan-count-clipped-elision.test.ts', 'test/fixtures/eng-d1-clipped-elision-1579.json', 'test/fixtures/eng-d2-planning-prelude-4d.json', 'test/fixtures/ceo-approach-z-call.json', 'test/fixtures/ceo-approach-z-screen.txt', 'test/helpers/native-auto-decide.ts', 'test/auto-decide-current-declaration.test.ts', 'test/fixtures/auto-decide-current-declaration-6aef.json', 'test/auto-decide-explanatory-mode.test.ts', 'test/fixtures/auto-decide-explanatory-mode-043a.json', 'test/fixtures/auto-decide-explanatory-mode-749df.json', 'test/auto-decide-structured.test.ts', 'test/fixtures/auto-decide-structured-77.json', 'test/helpers/auto-decision-state.ts', 'test/auto-decision-state.test.ts', 'test/fixtures/auto-decide-state-cab3.json', 'bin/zstack-question-log', 'test/native-auto-decide.test.ts', 'test/native-auto-decide-pty.test.ts', 'test/helpers/fake-plan-seed.ts', 'test/helpers/plan-seed-submission.ts', 'test/plan-seed-submission.test.ts', 'test/fixtures/plan-seed-cli.ts', 'test/fixtures/native-auto-decide-ag.json', 'test/eng-seeded-completion-ai.test.ts', 'test/fixtures/eng-seeded-completion-ai.json', 'test/helpers/plan-count-pending-exit.ts', 'test/plan-count-pending-exit.test.ts', 'test/helpers/pty-screen.ts', 'test/pty-screen.test.ts', 'test/pty-screen-session.test.ts', 'test/fixtures/pty-screen/**',
  ...
  'tpa-absent-linux':            ['test/session-runner-stream-lifecycle.test.ts', 'scripts/resolvers/third-party-actions.ts', 'ship/SKILL.md.tmpl', 'ship/sections/apple-release.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/helpers/session-runner.ts', 'test/skill-e2e-third-party-actions.test.ts', 'test/helpers/third-party-actions.ts',
    'test/third-party-actions-recording.test.ts', 'lib/eval-model.ts'
  ],
  'tpa-broken':                  ['test/session-runner-stream-lifecycle.test.ts', 'scripts/resolvers/third-party-actions.ts', 'ship/SKILL.md.tmpl', 'ship/sections/apple-release.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/helpers/session-runner.ts', 'test/skill-e2e-third-party-actions.test.ts', 'test/helpers/third-party-actions.ts',
    'test/third-party-actions-recording.test.ts', 'lib/eval-model.ts'
  ],
  'tpa-absent-darwin':           ['test/session-runner-stream-lifecycle.test.ts', 'scripts/resolvers/third-party-actions.ts', 'ship/SKILL.md.tmpl', 'ship/sections/apple-release.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/helpers/session-runner.ts', 'test/skill-e2e-third-party-actions.test.ts', 'test/helpers/third-party-actions.ts',
    'test/third-party-actions-recording.test.ts', 'lib/eval-model.ts'
  ],
  'tpa-apple-ban':               ['test/session-runner-stream-lifecycle.test.ts', 'scripts/resolvers/third-party-actions.ts', 'ship/SKILL.md.tmpl', 'ship/sections/apple-release.md.tmpl', 'scripts/gen-skill-docs.ts', 'test/helpers/session-runner.ts', 'test/skill-e2e-third-party-actions.test.ts', 'test/helpers/third-party-actions.ts',
    'test/third-party-actions-recording.test.ts', 'lib/eval-model.ts'
  ],
  ...
  'autoplan-chain-pty':          [
    ...
    'test/eng-finding-retry-budget.test.ts','scripts/resolvers/learnings.ts', 'test/zstack-brain-context-load.test.ts',
    "test/plan-count-cross-cwd-ancestry.test.ts", "test/fixtures/plan-count-cross-cwd-ancestry-0bcd.json", "test/plan-count-session-cwd.test.ts",
    ...
    'scripts/resolvers/design-doc-discovery.ts', 'bin/zstack-skill-start', 'bin/zstack-paths', 'test/zstack-paths.test.ts', 'test/pty-workspace-trust.test.ts', 'test/fixtures/pty-companion-cli.ts', 'lib/fs-atomic.ts', 'test/helpers/autoplan-phase-order.ts', 'test/autoplan-fixture.test.ts', 'test/fixtures/autoplan-caller.fixture.test.ts', 'test/autoplan-phase-observation.test.ts', 'test/helpers/owned-claude-transcript.ts', 'test/helpers/pty-current-screen.ts', 'test/pty-current-screen.test.ts', 'test/fixtures/native-viewport.ts', 'test/helpers/plan-skill-questions.ts', 'test/fixtures/eng-auq-validation-error.json', 'test/fixtures/bash-directory-permission.json', 'test/fixtures/design-tasks-bash-permission.json', 'test/plan-skill-read-permission.test.ts', 'test/fixtures/read-permission.json', 'test/pty-numbered-option-indent-native.test.ts', 'test/fixtures/ceo-split-e5-numbered-description-491.json', 'test/plan-skill-questions.test.ts', 'test/helpers/plan-skill-question-events.ts', 'test/plan-skill-question-events.test.ts', 'test/helpers/plan-skill-question-hook-scope.ts', 'test/helpers/skill-census.ts', 'test/plan-skill-question-hook-scope.test.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'test/autoplan-permission-viewport.test.ts', 'test/plan-review-cases.test.ts', 'scripts/resolvers/tasks-section.ts', 'scripts/resolvers/design.ts', 'test/fixtures/autoplan-settings-overwrite.json'
  ],
  ...
  'plan-devex-finding-count':    [
    ...
    'bin/zstack-decision-log', 'lib/zstack-decision.ts', 'test/pty-workspace-trust.test.ts', 'test/fixtures/pty-companion-cli.ts', 'test/helpers/autoplan-phase-order.ts', 'test/autoplan-phase-observation.test.ts', 'lib/fs-atomic.ts', 'test/devex-finding-fixture.test.ts', 'test/fixtures/devex-checkpoint-todos.json', 'test/helpers/owned-claude-transcript.ts', 'test/helpers/plan-skill-completion.ts', 'test/plan-skill-completion.test.ts', 'test/eval-budgets-policy.test.ts', 'test/fixtures/webfetch-permission.json', 'test/plan-skill-webfetch-permission.test.ts', 'test/helpers/plan-skill-questions.ts', 'test/fixtures/eng-auq-validation-error.json', 'test/fixtures/bash-directory-permission.json', 'test/fixtures/design-tasks-bash-permission.json', 'test/plan-skill-read-permission.test.ts', 'test/fixtures/read-permission.json', 'test/pty-numbered-option-indent-native.test.ts', 'test/fixtures/ceo-split-e5-numbered-description-491.json', 'test/plan-skill-questions.test.ts', 'test/helpers/plan-skill-question-events.ts', 'test/plan-skill-question-events.test.ts', 'test/helpers/plan-skill-question-hook-scope.ts', 'test/helpers/skill-census.ts', 'test/plan-skill-question-hook-scope.test.ts', 'test/helpers/ceo-finding-fixture.ts', 'test/ceo-finding-fixture.test.ts', 'test/helpers/pty-current-screen.ts', 'test/pty-current-screen.test.ts', 'test/fixtures/native-viewport.ts', 'test/helpers/plan-review-decisions.ts', 'test/plan-review-decisions.test.ts', 'test/helpers/plan-review-cases.ts', 'test/plan-review-cases.test.ts', 'test/helpers/llm-judge.ts', 'lib/eval-model.ts', 'test/skill-e2e-plan-decision-classification.test.ts', 'test/fixtures/plan-decision-classification.ts', 'test/plan-review-calibration.test.ts', 'scripts/resolvers/review.ts', 'test/fixtures/devex-existing-sdk/README.md', 'test/fixtures/devex-existing-sdk/docs/getting-started.md', 'test/fixtures/devex-existing-sdk/docs/feedback.md', 'test/fixtures/devex-existing-sdk/docs/reference-v1.md'
  ],
  ...
  'plan-ceo-split-overflow': [
    ...
    'test/eng-finding-retry-budget.test.ts',
    "test/plan-count-cross-cwd-ancestry.test.ts", "test/fixtures/plan-count-cross-cwd-ancestry-0bcd.json", "test/plan-count-session-cwd.test.ts",
'test/pty-screen-unicode-ap.test.ts', 'test/design-crop-gutter-ap.test.ts', 'test/fixtures/design-crop-gutter-ap.json', 'bin/zstack-config', 'plan-ceo-review/**', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'bin/zstack-question-preference', 'test/helpers/claude-pty-runner.ts', 'test/plan-count-design-ui-recovery.test.ts', 'test/fixtures/design-ui-boxed-question.json', 'test/plan-count-native-input.test.ts', 'test/helpers/pty-screen.ts', 'test/pty-screen.test.ts', 'test/pty-screen-session.test.ts', 'test/fixtures/pty-screen/**', 'test/helpers/hermetic-skill-runtime.ts', 'test/hermetic-skill-runtime.test.ts', 'test/helpers/claude-pty-runner.unit.test.ts', 'test/helpers/pty-trust-dialog.ts', 'test/pty-trust-dialog.test.ts', 'test/helpers/plan-count-transcript.ts', 'test/autoplan-public-narration.test.ts', 'test/fixtures/autoplan-public-narration-ad.json', 'test/helpers/plan-count-pending-exit.ts', 'test/plan-count-pending-exit.test.ts', 'test/plan-count-transcript.test.ts', 'test/helpers/plan-count-artifacts.ts', 'test/plan-count-artifacts.test.ts', 'test/helpers/eval-store.ts', 'test/helpers/plan-count-fixture.ts', 'test/plan-count-fixture.test.ts', 'test/plan-count-collection-completion.test.ts', 'test/plan-count-timeout.test.ts', 'test/plan-count-navigation-r.test.ts', 'test/plan-count-prerequisite-n.test.ts', 'test/fixtures/ceo-prerequisite-n-call.json', 'test/fixtures/eng-prerequisite-77.json', 'test/fixtures/forcing-finding-seeds.ts', 'test/skill-e2e-plan-ceo-split-overflow.test.ts', 'test/plan-count-checkbox.test.ts', 'test/fixtures/ceo-checkbox-l.screen.txt', 'test/helpers/plan-count-file-permission.ts', 'test/plan-edit-cropped-permission.test.ts', 'test/fixtures/plan-edit-cropped-permission-1579.json', 'test/plan-count-file-permission.test.ts', 'test/fixtures/plan-count-edit-permission-t.json', 'test/plan-count-owned-permission.test.ts', 'test/fixtures/plan-count-owned-permission-v.json', 'test/fixtures/ceo-questionless-w-native.json', 'test/plan-count-truncated-border.test.ts', 'test/fixtures/eng-d2-truncated-border-0bcd.json', 'test/plan-count-truncated-question.test.ts', 'test/plan-count-clipped-elision.test.ts', 'test/fixtures/eng-d1-clipped-elision-1579.json', 'test/fixtures/eng-d2-planning-prelude-4d.json', 'test/fixtures/ceo-approach-z-call.json', 'test/fixtures/ceo-approach-z-screen.txt', 'test/plan-count-permission-ac.test.ts', 'test/fixtures/plan-count-permission-ac.json', 'test/fixtures/plan-count-permission-ad.json', 'test/fixtures/plan-count-permission-ae.json', 'test/fixtures/plan-count-permission-target-ad-v2.json', 'test/fixtures/plan-count-permission-ah.json',
    'test/plan-count-crop-ak.test.ts',
    'test/fixtures/plan-count-crop-ak.json',
    'test/plan-count-quoted-frame-ak.test.ts',
    'test/fixtures/plan-count-quoted-frame-ak.json',
    'docs/askuserquestion-split.md', 'test/resolver-ask-user-format.test.ts', 'bin/zstack-slug', 'test/helpers/hermetic-env.test.ts', 'test/pty-workspace-trust.test.ts', 'test/fixtures/pty-companion-cli.ts', 'test/helpers/autoplan-phase-order.ts', 'test/autoplan-phase-observation.test.ts', 'lib/fs-atomic.ts', 'test/helpers/ceo-finding-fixture.ts', 'test/ceo-finding-fixture.test.ts', 'test/helpers/owned-claude-transcript.ts', 'test/helpers/plan-skill-completion.ts', 'test/plan-skill-completion.test.ts', 'test/eval-budgets-policy.test.ts', 'test/fixtures/webfetch-permission.json', 'test/plan-skill-webfetch-permission.test.ts', 'test/helpers/plan-skill-questions.ts', 'test/fixtures/eng-auq-validation-error.json', 'test/fixtures/bash-directory-permission.json', 'test/fixtures/design-tasks-bash-permission.json', 'test/plan-skill-read-permission.test.ts', 'test/fixtures/read-permission.json', 'test/pty-numbered-option-indent-native.test.ts', 'test/fixtures/ceo-split-e5-numbered-description-491.json', 'test/plan-skill-questions.test.ts', 'test/helpers/plan-skill-question-events.ts', 'test/plan-skill-question-events.test.ts', 'test/helpers/plan-skill-question-hook-scope.ts', 'test/helpers/skill-census.ts', 'test/plan-skill-question-hook-scope.test.ts', 'test/helpers/pty-current-screen.ts', 'test/pty-current-screen.test.ts', 'test/fixtures/native-viewport.ts', 'test/helpers/plan-review-decisions.ts', 'test/plan-review-decisions.test.ts', 'test/helpers/plan-review-cases.ts', 'test/plan-review-cases.test.ts', 'test/helpers/llm-judge.ts', 'lib/eval-model.ts', 'test/skill-e2e-plan-decision-classification.test.ts', 'test/fixtures/plan-decision-classification.ts', 'test/plan-review-calibration.test.ts', 'test/helpers/ceo-split-question-policy.ts', 'test/fixtures/ceo-split-actor-6aef.json', 'test/helpers/ceo-mode-option.ts', 'test/ceo-mode-option.test.ts', 'test/ceo-split-collection.test.ts', 'test/fixtures/ceo-split-collection-0bcd.json', 'test/ceo-split-question-policy.test.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  'brain-privacy-gate':           ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'scripts/resolvers/preamble/generate-brain-sync-block.ts', 'scripts/resolvers/preamble.ts', 'bin/zstack-brain-sync', 'bin/zstack-artifacts-init', 'bin/zstack-config', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-brain-privacy-gate.test.ts',
  ...
  'setup-gbrain-remote':          ['test/session-runner-stream-lifecycle.test.ts',
    'test/setup-gbrain-remote-caller.test.ts', 'test/helpers/setup-gbrain-sandbox.ts', 'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts', 'test/helpers/eval-store.ts', 'test/helpers/e2e-helpers.ts', 'lib/redact-engine.ts', 'lib/redact-patterns.ts', 'lib/eval-model.ts','setup-gbrain/sections/brain-init.md.tmpl', 'setup-gbrain/sections/claude-md-persist.md.tmpl', 'setup-gbrain/sections/manifest.json', 'test/helpers/setup-gbrain-fixture.ts', 'setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'bin/zstack-artifacts-init', 'bin/zstack-gbrain-detect', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-remote.test.ts',
    'test/agent-sdk-runner.test.ts'
  ],
  'setup-gbrain-bad-token':       ['test/session-runner-stream-lifecycle.test.ts', 'setup-gbrain/sections/brain-init.md.tmpl', 'setup-gbrain/sections/manifest.json', 'test/helpers/setup-gbrain-fixture.ts', 'setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-bad-token.test.ts',
    'test/agent-sdk-runner.test.ts', 'test/helpers/setup-gbrain-sandbox.ts', 'lib/redact-engine.ts', 'lib/redact-patterns.ts', 'test/helpers/setup-gbrain-fixture-command.ts', 'test/setup-gbrain-fixture.test.ts', 'bin/zstack-gbrain-detect', 'lib/gbrain-local-status.ts', 'lib/gbrain-exec.ts', 'bin/zstack-gbrain-lib.sh', 'bin/zstack-egress-lib.sh', 'bin/zstack-egress-receipt', 'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts'
  ],
  ...
  'setup-gbrain-path4-local-pglite': ['test/session-runner-stream-lifecycle.test.ts', 'setup-gbrain/sections/brain-init.md.tmpl', 'setup-gbrain/sections/claude-md-persist.md.tmpl', 'setup-gbrain/sections/manifest.json', 'test/helpers/setup-gbrain-fixture.ts', 'setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'bin/zstack-gbrain-install', 'bin/zstack-gbrain-detect', 'lib/gbrain-local-status.ts', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-path4-local-pglite.test.ts', 'test/setup-gbrain-path4-caller.test.ts',
    'test/agent-sdk-runner.test.ts', 'test/helpers/setup-gbrain-sandbox.ts', 'lib/redact-engine.ts', 'lib/redact-patterns.ts', 'test/helpers/setup-gbrain-fixture-command.ts', 'test/setup-gbrain-fixture.test.ts', 'lib/gbrain-exec.ts', 'bin/zstack-gbrain-lib.sh', 'bin/zstack-egress-lib.sh', 'bin/zstack-egress-receipt', 'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts'
  ],

  // AskUserQuestion format regression (RECOMMENDATION + Completeness: N/10)
  // Fires when either template OR the two preamble resolvers change.
  'plan-ceo-review-format-mode':      ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completeness-section.ts', 'scripts/resolvers/preamble.ts', 'model-overlays/opus-4-7.md', 'test/helpers/llm-judge.ts', 'test/skill-e2e-plan-format.test.ts',
    'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  'plan-ceo-review-format-approach':  ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completeness-section.ts', 'scripts/resolvers/preamble.ts', 'model-overlays/opus-4-7.md', 'test/helpers/llm-judge.ts', 'test/skill-e2e-plan-format.test.ts',
    'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  ...
  'plan-review-prosons-hardstop-neg': ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'model-overlays/opus-4-7.md', 'test/skill-e2e-plan-prosons.test.ts',
    'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  'plan-review-prosons-neutral-neg':  ['test/session-runner-stream-lifecycle.test.ts', 'test/paid-retry-supervision.test.ts', 'plan-ceo-review/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'model-overlays/opus-4-7.md', 'test/skill-e2e-plan-prosons.test.ts',
    'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts', 'scripts/resolvers/tasks-section.ts'
  ],
  ...
  'plan-tune-inspect':         ['test/session-runner-stream-lifecycle.test.ts', 'plan-tune/**', 'scripts/question-registry.ts', 'scripts/psychographic-signals.ts', 'scripts/one-way-doors.ts', 'bin/zstack-question-log', 'bin/zstack-question-preference', 'bin/zstack-developer-profile', 'test/skill-e2e-plan-tune.test.ts'],

  // /plan-tune cathedral (T16 — 5 E2E scenarios, all gate per D12)
  'plan-tune-hook-capture':      ['hosts/claude/hooks/**', 'bin/zstack-question-log', 'bin/zstack-developer-profile', 'plan-tune/**', 'test/skill-e2e-plan-tune-cathedral.test.ts', 'lib/jsonl-store.ts', 'lib/is-conductor.ts', 'test/plan-tune-cathedral-fixture.test.ts'],
  'plan-tune-enforcement':       ['hosts/claude/hooks/**', 'bin/zstack-question-preference', 'scripts/question-registry.ts', 'test/skill-e2e-plan-tune-cathedral.test.ts', 'lib/jsonl-store.ts', 'lib/is-conductor.ts', 'test/plan-tune-cathedral-fixture.test.ts'],
  ...
  'plan-tune-codex-import':      ['bin/zstack-codex-session-import', 'bin/zstack-question-log', 'docs/spikes/codex-session-format.md', 'test/skill-e2e-plan-tune-cathedral.test.ts', 'lib/jsonl-store.ts', 'lib/is-conductor.ts', 'test/plan-tune-cathedral-fixture.test.ts'],
  'plan-tune-dream-cycle':       ['bin/zstack-distill-free-text', 'bin/zstack-distill-apply', 'hosts/claude/hooks/**', 'plan-tune/**', 'test/skill-e2e-plan-tune-cathedral.test.ts', 'lib/jsonl-store.ts', 'lib/is-conductor.ts', 'test/plan-tune-cathedral-fixture.test.ts'],
  ...
  // Ship
  'ship-base-branch': ['test/session-runner-stream-lifecycle.test.ts', 'ship/**', 'bin/zstack-repo-mode', 'test/skill-e2e-review-attribution.test.ts',
    'scripts/resolvers/testing.ts'
  ],
  ...
  'review-dashboard-via': ['test/session-runner-stream-lifecycle.test.ts', 'ship/**', 'scripts/resolvers/review.ts', 'codex/**', 'autoplan/**', 'land-and-deploy/**', 'test/skill-e2e-review-attribution.test.ts',
    'scripts/resolvers/testing.ts'
  ],

  // Retro
  'retro':             ['test/session-runner-stream-lifecycle.test.ts', 'bin/zstack-retro-metrics', 'retro/**', 'test/skill-e2e-retro.test.ts'],
  'retro-base-branch': ['test/session-runner-stream-lifecycle.test.ts', 'bin/zstack-retro-metrics', 'retro/**', 'test/skill-e2e-retro.test.ts'],

  // CSO
  'cso-full-audit':   ['test/session-runner-stream-lifecycle.test.ts', 'cso/**', 'lib/cso/**', 'lib/redact-engine.ts', 'lib/redact-patterns.ts', 'test/cso-cli.test.ts', 'test/cso-snapshot-state.test.ts', 'test/skill-e2e-cso.test.ts'],
  'cso-diff-mode':    ['test/session-runner-stream-lifecycle.test.ts', 'cso/**', 'lib/cso/**', 'lib/redact-engine.ts', 'lib/redact-patterns.ts', 'test/cso-cli.test.ts', 'test/cso-snapshot-state.test.ts', 'test/skill-e2e-cso.test.ts'],
  'cso-infra-scope':  ['test/session-runner-stream-lifecycle.test.ts', 'cso/**', 'lib/cso/**', 'lib/redact-engine.ts', 'lib/redact-patterns.ts', 'test/cso-cli.test.ts', 'test/cso-snapshot-state.test.ts', 'test/skill-e2e-cso.test.ts'],

  // Learnings
  'learnings-show': ['test/session-runner-stream-lifecycle.test.ts', 'learn/**', 'bin/zstack-learnings-search', 'bin/zstack-learnings-log', 'scripts/resolvers/learnings.ts', 'test/skill-e2e-learnings.test.ts'],

  // Session Intelligence (timeline, context recovery, /context-save + /context-restore)
  'timeline-event-flow':            ['test/session-runner-stream-lifecycle.test.ts', 'bin/zstack-timeline-log', 'bin/zstack-timeline-read', 'test/skill-e2e-session-intelligence.test.ts'],
  'context-recovery-artifacts':     ['test/session-runner-stream-lifecycle.test.ts', 'scripts/resolvers/preamble.ts', 'bin/zstack-timeline-log', 'bin/zstack-slug', 'learn/**', 'test/skill-e2e-session-intelligence.test.ts'],
  'context-save-writes-file':       ['test/session-runner-stream-lifecycle.test.ts', 'context-save/**', 'bin/zstack-slug', 'test/skill-e2e-session-intelligence.test.ts'],
  'context-restore-loads-latest':   ['test/session-runner-stream-lifecycle.test.ts', 'context-restore/**', 'bin/zstack-slug', 'test/skill-e2e-session-intelligence.test.ts'],
  ...
  'context-save-then-restore-roundtrip':   ['test/session-runner-stream-lifecycle.test.ts', 'context-save/**', 'context-restore/**', 'bin/zstack-slug', 'test/skill-e2e-context-skills.test.ts'],
  ...
  'codex-review': ['test/session-runner-stream-lifecycle.test.ts', 'codex/**', 'test/skill-e2e-workflow.test.ts'],
  ...
  'outside-voice-codex-to-claude-code': ['test/session-runner-stream-lifecycle.test.ts',
    ...
    'bin/zstack-claude-code', 'lib/claude-code.ts', 'lib/claude-code-windows-job.ts', 'lib/claude-bin.ts', 'lib/outside-review-result.ts', 'test/helpers/codex-session-runner.ts',
  ...
  'outside-voice-claude-code-to-codex': ['test/session-runner-stream-lifecycle.test.ts',
    'review/**', 'codex/**', 'hosts/claude.ts', 'hosts/define-host.ts',
    'scripts/gen-skill-docs.ts', 'scripts/resolvers/index.ts', 'scripts/resolvers/outside-voice.ts',
    'scripts/resolvers/constants.ts', 'scripts/resolvers/review.ts',
    'bin/zstack-codex-probe', 'lib/outside-review-result.ts', 'test/helpers/session-runner.ts',
  ...
  'outside-plan-disabled-no-fallback': ['test/session-runner-stream-lifecycle.test.ts',
    ...
    'bin/zstack-config', 'bin/zstack-codex-probe', 'bin/zstack-review-log', 'bin/zstack-review-read', 'lib/review-evidence.ts', 'bin/zstack-slug', 'bin/zstack-wtree', 'bin/zstack-brain-enqueue', 'test/helpers/session-runner.ts',
  ...
  'ship-coverage-audit': ['test/session-runner-stream-lifecycle.test.ts',
    ...
    'test/fixtures/ship-coverage-audit-af.json','ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/zstack-repo-mode', 'test/skill-e2e-workflow.test.ts',
  ...
  'ship-triage': ['test/session-runner-stream-lifecycle.test.ts', 'ship/**', 'bin/zstack-repo-mode', 'test/skill-e2e-triage.test.ts',
    'scripts/resolvers/testing.ts'
  ],
  ...
  'docsync-spawned': ['test/session-runner-stream-lifecycle.test.ts',
    ...
    'bin/zstack-session-kind',
    'bin/zstack-skill-start',
  ...
  'design-consultation-existing':   ['test/session-runner-stream-lifecycle.test.ts', 'design-consultation/**', 'lib/design-md.ts', 'bin/zstack-design-md.ts', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-design.test.ts'],
  ...
  'design-review-fix':              ['test/session-runner-stream-lifecycle.test.ts', 'design-review/**', 'scripts/resolvers/aside.ts', 'scripts/resolvers/design.ts', 'lib/design-catalog.ts', 'browse/src/**', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-design.test.ts',
    'scripts/resolvers/testing.ts'
  ],
  ...
  'design-review-detector-shim':    ['test/session-runner-stream-lifecycle.test.ts', 'design-review/**', 'scripts/resolvers/design.ts', 'lib/design-catalog.ts', 'lib/design-detect-contract.ts', 'lib/dom-dump-script.ts', 'lib/dom-dump.js', 'bin/zstack-design-detect.ts', 'test/helpers/fake-impeccable.ts', 'test/fixtures/fake-impeccable.ts', 'test/fixtures/impeccable-detect-sample.json', 'test/fixtures/review-eval-design-slop.*', 'test/skill-e2e-design.test.ts',
    'scripts/resolvers/testing.ts'
  ],
  'design-review-detector-shim-dom': ['test/session-runner-stream-lifecycle.test.ts', 'design-review/**', 'scripts/resolvers/design.ts', 'lib/design-detect-contract.ts', 'lib/dom-dump-script.ts', 'lib/dom-dump.js', 'bin/zstack-design-detect.ts', 'browse/src/**', 'test/helpers/fake-impeccable.ts', 'test/fixtures/fake-impeccable.ts', 'test/fixtures/impeccable-detect-sample.json', 'test/fixtures/review-eval-design-slop.*', 'test/skill-e2e-design.test.ts',
    'scripts/resolvers/testing.ts'
  ],
  'design-html-slop-gate':          ['test/session-runner-stream-lifecycle.test.ts', 'test/zstack-paths.test.ts', 'design-html/**', 'scripts/resolvers/design.ts', 'lib/design-detect-contract.ts', 'bin/zstack-design-detect.ts', 'test/helpers/fake-impeccable.ts', 'test/fixtures/fake-impeccable.ts', 'test/fixtures/impeccable-detect-sample.json', 'test/skill-e2e-design.test.ts'],
  ...
  // Both render the triplet through zstack-render (lib/aside-render.ts +
  // bin/zstack-render.ts): Aside when it is running, the browse daemon
  // otherwise — so both engines are deps. Triplet = deterministic functional
  // (gate); authoring quality = LLM-judged benchmark (periodic).
  'diagram-triplet':            ['test/session-runner-stream-lifecycle.test.ts', 'diagram/**', 'lib/diagram-render/**', 'lib/aside-render.ts', 'bin/zstack-render.ts', 'test/helpers/aside-available.ts', 'browse/src/**', 'test/skill-e2e-diagram.test.ts'],
  'diagram-authoring-quality':  ['test/session-runner-stream-lifecycle.test.ts', 'diagram/**', 'lib/diagram-render/**', 'lib/aside-render.ts', 'bin/zstack-render.ts', 'test/helpers/aside-available.ts', 'browse/src/**', 'test/helpers/llm-judge.ts', 'test/skill-e2e-diagram.test.ts'],

  // zstack-upgrade
  'zstack-upgrade-happy-path': ['test/session-runner-stream-lifecycle.test.ts', 'zstack-upgrade/**', 'test/skill-e2e-workflow.test.ts'],
  ...
  'land-and-deploy-first-run':     ['test/session-runner-stream-lifecycle.test.ts', 'land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/zstack-slug', 'test/skill-e2e-deploy.test.ts'],
  'land-and-deploy-review-gate':   ['test/session-runner-stream-lifecycle.test.ts', 'land-and-deploy/**', 'bin/zstack-review-read', 'test/skill-e2e-deploy.test.ts'],
  ...
  // Autoplan
  'autoplan-dual-voice': ['test/session-runner-stream-lifecycle.test.ts',
    'test/autoplan-dual-voice-fixture.test.ts', 'test/helpers/hermetic-env.ts',
    'test/helpers/autoplan-dual-voice-evidence.ts', 'test/autoplan-dual-voice-evidence.test.ts',
  ...
  'benchmark-providers-live': ['bin/zstack-model-benchmark', 'test/helpers/providers/**', 'test/helpers/benchmark-runner.ts', 'test/helpers/pricing.ts', 'test/skill-e2e-benchmark-providers.test.ts'],
  ...
  'scrape-match-path': ['test/session-runner-stream-lifecycle.test.ts',
  ...
  'scrape-prototype-path': ['test/session-runner-stream-lifecycle.test.ts',
    'scrape/**', 'browse/src/browser-skills.ts', 'browse/src/browser-skill-commands.ts',
    'test/skill-e2e-skillify.test.ts',
  ],
  'skillify-happy-path': ['test/session-runner-stream-lifecycle.test.ts',
    'skillify/**', 'scrape/**', 'browse/src/browser-skill-write.ts',
    'browse/src/browser-skills.ts', 'browse/src/browser-skill-commands.ts',
    'test/skill-e2e-skillify.test.ts',
  ],
  'skillify-provenance-refusal': ['test/session-runner-stream-lifecycle.test.ts',
    'skillify/**', 'browse/src/browser-skill-write.ts',
    'test/skill-e2e-skillify.test.ts',
  ],
  'skillify-approval-reject': ['test/session-runner-stream-lifecycle.test.ts',
    'skillify/**', 'scrape/**', 'browse/src/browser-skill-write.ts',
    'test/skill-e2e-skillify.test.ts',
  ],
  ...
  // path requires ZSTACK_HAS_IOS_DEVICE=1 and is periodic-tier.
  ...
  // Real-device path — only runs with ZSTACK_HAS_IOS_DEVICE=1 + a paired
  ...
  'spec-execute':     ['spec/**', 'scripts/resolvers/redact-doc.ts', 'scripts/resolvers/outside-voice.ts', 'scripts/resolvers/constants.ts', 'lib/outside-review-result.ts', 'bin/zstack-redact', 'lib/redact-engine.ts', 'test/skill-e2e-spec-execute.test.ts'],
  ...
  'office-hours-brain-writeback': ['test/session-runner-stream-lifecycle.test.ts', 'office-hours/sections/**',
    'scripts/resolvers/gbrain.ts',
    'scripts/gen-skill-docs.ts',
    'bin/zstack-gbrain-detect',
    'bin/zstack-config',
    ...
    'test/helpers/office-hours-attempt.ts', 'test/office-hours-attempt.test.ts', 'test/office-hours-writeback-env.test.ts'
  ],

  // gbrain CLI real round-trip against a local PGLite store (v1.50.0.0
  // T11). Proves the gbrain CLI persistence contract zstack relies on —
  ...
  'office-hours-section-loading': ['test/session-runner-stream-lifecycle.test.ts', 'office-hours/**', 'bin/zstack-office-hours-review', 'lib/office-hours-review.ts', 'lib/fs-atomic.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/sections.ts', 'scripts/gen-skill-docs.ts', 'test/helpers/carve-guards.ts', 'test/helpers/auq-sdk-capture.ts', 'test/section-capture-native-tools.test.ts', 'test/helpers/office-hours-completion.ts', 'test/helpers/llm-judge.ts', 'test/helpers/session-runner.ts', 'test/skill-e2e-office-hours-section-loading.test.ts'],
  'plan-devex-peer-comparison-classification': [
    'test/plan-review-native-default.test.ts',
    'test/fixtures/eng-omitted-select-361c.json',
'test/skill-e2e-plan-devex-peer-comparison-classification.test.ts', 'test/fixtures/devex-peer-comparison-classification.ts', 'test/devex-peer-comparison-calibration.test.ts', 'test/helpers/plan-review-decisions.ts', 'test/plan-review-decisions.test.ts', 'test/helpers/plan-review-cases.ts', 'test/plan-review-cases.test.ts', 'test/helpers/llm-judge.ts', 'lib/eval-model.ts', 'test/helpers/e2e-helpers.ts', 'test/helpers/eval-store.ts', 'test/helpers/eval-budgets.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'docs/askuserquestion-split.md', 'plan-devex-review/SKILL.md.tmpl', 'plan-devex-review/sections/review-sections.md.tmpl'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  'carve-section-loading':     'periodic',   // ~$1-2/skill, data-driven; ZSTACK_CARVE_SKILL scopes to one
  ...
  // Privacy gate for zstack-brain-sync — periodic (non-deterministic LLM call,
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'zstack-upgrade/SKILL.md upgrade flow': ['zstack-upgrade/SKILL.md', 'zstack-upgrade/SKILL.md.tmpl', 'test/skill-llm-eval.test.ts', 'test/helpers/workflow-judge-input.ts', 'test/helpers/workflow-judge-cache.ts', 'test/workflow-judge-cache.test.ts', 'scripts/eval-input-cache.ts', 'test/eval-input-cache.test.ts', 'test/workflow-judge-input.test.ts', 'test/helpers/workflow-excerpt.ts'],
