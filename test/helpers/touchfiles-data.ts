...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'first-task-scaffold': ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'bin/zstack-first-task-detect', 'scripts/resolvers/preamble/generate-preamble-bash.ts', 'test/skill-e2e-first-task-scaffold.test.ts', 'test/helpers/session-runner.ts'],
  ...
  'operational-learning':     ['scripts/resolvers/preamble.ts', 'bin/zstack-learnings-log', 'test/skill-e2e-bws.test.ts'],
  ...
  'review-army-migration-safety': ['review/**', 'scripts/resolvers/review-army.ts', 'bin/zstack-diff-scope', 'test/skill-e2e-review-army.test.ts'],
  'review-army-perf-n-plus-one':  ['review/**', 'scripts/resolvers/review-army.ts', 'bin/zstack-diff-scope', 'test/skill-e2e-review-army.test.ts'],
  ...
  'plan-ceo-review-plan-mode':    ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'plan-ceo-review/**', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/review.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-plan-ceo-plan-mode.test.ts'],
  'plan-eng-review-plan-mode':    ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'plan-eng-review/**', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/review.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-plan-eng-plan-mode.test.ts'],
  'plan-design-review-plan-mode': ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'plan-design-review/**', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/review.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-plan-design-plan-mode.test.ts', 'test/skill-e2e-design.test.ts'],
  'plan-devex-review-plan-mode':  ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'plan-devex-review/**', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/review.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-plan-devex-plan-mode.test.ts'],
  ...
  'plan-mode-no-op':              ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'plan-ceo-review/**', 'plan-eng-review/**', 'plan-design-review/**', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/preamble.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-plan-mode-no-op.test.ts'],
  ...
  'office-hours-auto-mode':       ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'office-hours/**', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-office-hours-auto-mode.test.ts'],
  'office-hours-phase4-fork':     ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'office-hours/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/question-tuning.ts', 'test/helpers/llm-judge.ts', 'test/skill-e2e-office-hours-phase4.test.ts'],
  ...
  'conductor-prose':              ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'bin/zstack-session-kind', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-preamble-bash.ts', 'scripts/resolvers/preamble.ts', 'plan-eng-review/**', 'hosts/claude/hooks/question-preference-hook.ts', 'hosts/claude/hooks/spawned-directive.ts', 'lib/is-conductor.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-conductor-prose.test.ts'],
  ...
  'ship-idempotency-pty':        ['ship/**', 'bin/zstack-next-version', 'bin/zstack-version-bump', 'scripts/resolvers/sections.ts', 'lib/worktree.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-ship-idempotency.test.ts'],
  ...
  'plan-eng-multi-finding-batching': ['bin/zstack-skill-start', 'bin/zstack-skill-end', 'plan-eng-review/**', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completion-status.ts', 'scripts/resolvers/review.ts', 'test/helpers/claude-pty-runner.ts', 'test/fixtures/forcing-finding-seeds.ts', 'test/skill-e2e-plan-eng-multi-finding-batching.test.ts'],
  'plan-ceo-split-overflow': ['plan-ceo-review/**', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'bin/zstack-question-preference', 'test/helpers/claude-pty-runner.ts', 'test/fixtures/forcing-finding-seeds.ts', 'test/skill-e2e-plan-ceo-split-overflow.test.ts'],
  ...
  'setup-gbrain-bad-token':       ['setup-gbrain/sections/brain-init.md.tmpl', 'setup-gbrain/sections/manifest.json', 'test/helpers/setup-gbrain-fixture.ts', 'setup-gbrain/SKILL.md.tmpl', 'bin/zstack-gbrain-mcp-verify', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-bad-token.test.ts'],
  ...
  'plan-tune-inspect':         ['plan-tune/**', 'scripts/question-registry.ts', 'scripts/psychographic-signals.ts', 'scripts/one-way-doors.ts', 'bin/zstack-question-log', 'bin/zstack-question-preference', 'bin/zstack-developer-profile', 'test/skill-e2e-plan-tune.test.ts'],

  // /plan-tune cathedral (T16 — 5 E2E scenarios, all gate per D12)
  'plan-tune-hook-capture':      ['hosts/claude/hooks/**', 'bin/zstack-question-log', 'bin/zstack-developer-profile', 'plan-tune/**', 'test/skill-e2e-plan-tune-cathedral.test.ts'],
  'plan-tune-enforcement':       ['hosts/claude/hooks/**', 'bin/zstack-question-preference', 'scripts/question-registry.ts', 'test/skill-e2e-plan-tune-cathedral.test.ts'],
  ...
  'plan-tune-codex-import':      ['bin/zstack-codex-session-import', 'bin/zstack-question-log', 'docs/spikes/codex-session-format.md', 'test/skill-e2e-plan-tune-cathedral.test.ts'],
  'plan-tune-dream-cycle':       ['bin/zstack-distill-free-text', 'bin/zstack-distill-apply', 'hosts/claude/hooks/**', 'plan-tune/**', 'test/skill-e2e-plan-tune-cathedral.test.ts'],
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/zstack-repo-mode', 'test/skill-e2e-review-attribution.test.ts'],
  ...
  // Retro
  'retro':             ['bin/zstack-retro-metrics', 'retro/**', 'test/skill-e2e-retro.test.ts'],
  'retro-base-branch': ['bin/zstack-retro-metrics', 'retro/**', 'test/skill-e2e-retro.test.ts'],
  ...
  // Learnings
  'learnings-show': ['learn/**', 'bin/zstack-learnings-search', 'bin/zstack-learnings-log', 'scripts/resolvers/learnings.ts', 'test/skill-e2e-learnings.test.ts'],

  // Session Intelligence (timeline, context recovery, /context-save + /context-restore)
  'timeline-event-flow':            ['bin/zstack-timeline-log', 'bin/zstack-timeline-read', 'test/skill-e2e-session-intelligence.test.ts'],
  'context-recovery-artifacts':     ['scripts/resolvers/preamble.ts', 'bin/zstack-timeline-log', 'bin/zstack-slug', 'learn/**', 'test/skill-e2e-session-intelligence.test.ts'],
  'context-save-writes-file':       ['context-save/**', 'bin/zstack-slug', 'test/skill-e2e-session-intelligence.test.ts'],
  'context-restore-loads-latest':   ['context-restore/**', 'bin/zstack-slug', 'test/skill-e2e-session-intelligence.test.ts'],
  ...
  'context-save-then-restore-roundtrip':   ['context-save/**', 'context-restore/**', 'bin/zstack-slug', 'test/skill-e2e-context-skills.test.ts'],
  ...
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/zstack-repo-mode', 'test/skill-e2e-workflow.test.ts'],
  ...
  'ship-triage': ['ship/**', 'bin/zstack-repo-mode', 'test/skill-e2e-triage.test.ts'],
  ...
  // zstack-upgrade
  'zstack-upgrade-happy-path': ['zstack-upgrade/**', 'test/skill-e2e-workflow.test.ts'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'test/skill-e2e-deploy.test.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/zstack-slug', 'test/skill-e2e-deploy.test.ts'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/zstack-review-read', 'test/skill-e2e-deploy.test.ts'],
  ...
  // Autoplan
  'autoplan-dual-voice': ['autoplan/**', 'codex/**', 'bin/zstack-codex-probe', 'scripts/resolvers/review.ts', 'scripts/resolvers/design.ts', 'test/skill-e2e-autoplan-dual-voice.test.ts'],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'zstack-upgrade/SKILL.md upgrade flow': ['zstack-upgrade/SKILL.md', 'zstack-upgrade/SKILL.md.tmpl', 'test/skill-llm-eval.test.ts'],
