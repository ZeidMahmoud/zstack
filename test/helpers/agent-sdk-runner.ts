 ...
 *
 * Default capacity 3. Override via ZSTACK_SDK_MAX_CONCURRENCY env var.
 */
class Semaphore {
...
const DEFAULT_SDK_CONCURRENCY = Number(process.env.ZSTACK_SDK_MAX_CONCURRENCY ?? 3);
...
export async function runAgentSdkTest(
  ...
  // scrub + ANTHROPIC_API_KEY + hermetic CLAUDE_CONFIG_DIR/ZSTACK_HOME), with
