/**
 * Contract tests for bin/zstack-redact — exit codes, JSON shape, flags,
...
const BIN = path.resolve(import.meta.dir, "..", "bin", "zstack-redact");
...
describe("zstack-redact exit codes", () => {
  test("clean → 0", () => {
...
describe("zstack-redact --auto-redact", () => {
...
describe("zstack-redact --allowlist", () => {
...
describe("zstack-redact --from-file", () => {
...
describe("zstack-redact oversize fails closed", () => {
...
describe("zstack-redact argv dispatch", () => {
  ...
  // "scan" is what the human output header ("zstack-redact scan — repo …")
