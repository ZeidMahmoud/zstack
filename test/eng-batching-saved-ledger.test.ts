...
for (const title of ['Historical Architecture review','Original plan','Implementation tasks','ZSTACK REVIEW REPORT']) test('a copied or foreign record section gives no credit: ' + title, () => {
  const plan = expanded.preAskPlan.replace('### R1:', `## ${title}\n\n### R1:`);
