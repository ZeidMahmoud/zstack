...
const OPENCLAW_NATIVE_SKILLS = [
  'openclaw/skills/zstack-openclaw-investigate/SKILL.md',
  'openclaw/skills/zstack-openclaw-office-hours/SKILL.md',
  'openclaw/skills/zstack-openclaw-ceo-review/SKILL.md',
  'openclaw/skills/zstack-openclaw-retro/SKILL.md',
];
