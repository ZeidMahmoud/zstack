...
QA test plan artifact written to `~/.zstack/projects/zstack-plan-count-v3IR5h/vercel-sandbox-main-eng-review-test-plan-20260910-193446.md` for `/qa` and `/qa-only`.
...
`TODOS.md` does not exist in this repository and cannot be created while plan mode is active. Create it with the entry below when implementation starts (format per zstack `TODOS-format.md`).
...
Tasks JSONL: `~/.zstack/projects/zstack-plan-count-v3IR5h/tasks-eng-review-20260910-193708.jsonl` (11 tasks).
