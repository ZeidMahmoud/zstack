...
export const FORCING_FLOOR_ENG = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/zstack-test-plan-eng-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_FLOOR_CEO = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/zstack-test-plan-ceo-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_FLOOR_DESIGN = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/zstack-test-plan-design-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_FLOOR_DEVEX = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/zstack-test-plan-devex-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_BATCHING_ENG = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/zstack-test-plan-eng-batching.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_SPLIT_OVERFLOW_CEO = [
  'Please review this plan and help me decide scope. Write your plan-mode plan to /tmp/zstack-test-plan-ceo-split-overflow.md (use Edit/Write to that exact path).',
  '',
