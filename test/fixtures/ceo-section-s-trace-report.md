...
(CC+zstack compresses these 6 human hours to ~20-30 minutes of wall time.)
...
**OUTSIDE COVERAGE:** codex_reviews=disabled; outside review step skipped per isolated config. Re-enable: `zstack-config set codex_reviews enabled`.
