 ...
 *  ~/.claude/skills/ is unsafe: it may contain symlinks from the real zstack
...
This project uses the following installed zstack skills: ${installedSkills.join(', ')}.
