/**
 * bin/zstack-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'zstack-question-log');
...
describe('zstack-question-log — valid payloads', () => {
...
describe('zstack-question-log — rejected payloads', () => {
...
describe('zstack-question-log — injection defense', () => {
  const attacks = [
