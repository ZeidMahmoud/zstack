 ...
 *     analyzed ref) live in bin/zstack-retro-metrics, emitted as
 ...
 * emissions lives in test/zstack-retro-metrics.test.ts.
 */
...
const METRICS_SCRIPT = path.join(ROOT, "bin", "zstack-retro-metrics");
