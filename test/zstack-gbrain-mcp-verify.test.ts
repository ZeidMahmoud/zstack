/**
 * zstack-gbrain-mcp-verify — error-classification tests with a mocked curl.
 *
...
const VERIFY_BIN = path.join(ROOT, 'bin', 'zstack-gbrain-mcp-verify');
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'zstack-mcp-verify-test-'));
...
describe('zstack-gbrain-mcp-verify', () => {
