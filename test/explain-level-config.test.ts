/**
 * zstack-config explain_level round-trip + validation tests.
 *
 * Coverage:
...
describe('zstack-config explain_level', () => {
  ...
  test('get with unset explain_level returns the documented default', () => {
    // zstack-config returns the documented default ("default") when the
    // key is absent from config.yaml — see bin/zstack-config:103. Earlier
