...
check('owned repo prefix cannot authorize another repository',false,x=>{const c=x.calls.at(-1)!,q=c.questions[0]!,answer=c.answers![q.question]!;q.question=q.question.replace(/^(Project\/branch\/task:.*)$/m,'$1; repo zstack-plan-count-eecImF/other');c.answers={[q.question]:answer};});
