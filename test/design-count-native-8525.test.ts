...
for (const [name, change] of Object.entries({
  ...
  'wrong path':(s:string)=>s.replaceAll('zstack-test-plan-design.md','wrong-plan.md'),
  'ambiguous path':(s:string)=>s.replace('now carries','and `another-plan.md` now carry'),
  'different absolute directory':(s:string)=>s.replaceAll('zstack-test-plan-design.md','/elsewhere/zstack-test-plan-design.md'),
  'relative traversal':(s:string)=>s.replaceAll('zstack-test-plan-design.md','../zstack-test-plan-design.md'),
...
for(const [name,change]of Object.entries({
  ...
  'foreign path':(s:string)=>s.replaceAll('zstack-test-plan-design.md','foreign-report.md'),
