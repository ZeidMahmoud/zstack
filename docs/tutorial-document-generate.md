...
- zstack installed (`git clone --single-branch --depth 1 https://github.com/ZeidMahmoud/zstack.git ~/.claude/skills/zstack && cd ~/.claude/skills/zstack && ./setup`)
...
- **If you want to understand why the four quadrants exist:** read [explanation-diataxis-in-zstack.md](./explanation-diataxis-in-zstack.md).
