...
- zstack installed (`./setup` complete; verify with `which zstack` or by typing `/` in Claude Code and seeing skills listed)
...
- **Why zstack uses the Diataxis framework:** [explanation-diataxis-in-zstack.md](./explanation-diataxis-in-zstack.md)
