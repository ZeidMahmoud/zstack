...
**Status:** Shipped on `tehran-v1` (one PR, 13 bisected commits). Promoted from the CEO plan at `~/.zstack/projects/garrytan-zstack/ceo-plans/2026-09-08-impeccable-design-interop.md`.
