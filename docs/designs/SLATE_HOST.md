...
**Date:** 2026-04-02
**Branch:** zeid/slate-agent-support
...
- Host names duplicated in `bin/zstack-platform-detect`, `bin/zstack-uninstall`, `bin/dev-setup`
...
- `bin/zstack-platform-detect` doesn't detect Slate
