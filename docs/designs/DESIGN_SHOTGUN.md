...
Branch: zeidmahmoud/agent-design-tools
...
5. $D serve writes board HTML with injected __ZSTACK_SERVER_URL
...
| HTML injection of server URL | __ZSTACK_SERVER_URL check | `serve.test.ts` |
