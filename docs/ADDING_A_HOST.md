# Adding a New Host to zstack

zstack uses a declarative host config system. Each supported AI coding agent
...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/zstack',
  localSkillRoot: '.myhost/skills/zstack',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/zstack', to: '~/.myhost/skills/zstack' },
    { from: '.claude/skills/zstack', to: '.myhost/skills/zstack' },
