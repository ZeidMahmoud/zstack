#!/usr/bin/env bun
/**
 * zstack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   zstack-global-discover --since 7d [--format json|summary]
 *   zstack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: zstack-global-discover --since <window> [--format json|summary]
...
Examples:
  zstack-global-discover --since 7d
  zstack-global-discover --since 14d --format summary`);
}
...
function resolveClaudeCodeCwd(
  ...
  // e.g., -Users-zeidmahmoud-git-repo → /Users/zeidmahmoud/git/repo
