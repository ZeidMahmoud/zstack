...
const factory: HostConfig = {
  ...
  globalRoot: '.factory/skills/zstack',
  localSkillRoot: '.factory/skills/zstack',
  hostSubdir: '.factory',
  usesEnvVars: true,
  ...
  pathRewrites: [
    ...
    { from: '.claude/skills/zstack', to: '.factory/skills/zstack' },
    { from: '.claude/skills/review', to: '.factory/skills/zstack/review' },
