/**
 * jsonl-store — shared plumbing for zstack's append-only JSONL stores in
 ...
 *      today: bin/zstack-learnings-log, bin/zstack-decision-log (via
 *      lib/zstack-decision.ts), bin/zstack-question-log.
 ...
 *
 * Extracted from `bin/zstack-learnings-log` (D2A) so the learnings/decision/
