 ...
 * per-repo indexing consent. Stored at `$ZSTACK_HOME/code-intelligence.json`
 * (default `~/.zstack/`), the same home the rest of zstack uses.
 *
 * Portions copyright (c) 2026 Sina Matian, time-attack/zstack (ZStack 2), MIT.
 *
...
/**
 * The per-remote trust store (zstack-gbrain-repo-policy) is the SINGLE
 ...
 * (the exact semantics runCodeImport in bin/zstack-gbrain-sync.ts enforces —
