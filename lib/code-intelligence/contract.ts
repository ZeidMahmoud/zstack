 ...
 *
 * zstack does not maintain a home-grown indexer. It defines this small contract
 ...
 * reliability contract as lib/zstack-decision-semantic.ts.
 *
 ...
 * same semantics as runCodeImport in bin/zstack-gbrain-sync.ts ("code ingest
...
export interface OpOptions {
   ...
   * CLI on PATH, temp ZSTACK_HOME). Matches the existing gbrain helpers.
   */
