...
window.EXCALIDRAW_ASSET_PATH = "https://zstack-render.localhost/excalidraw-assets/";
...
window.__bundleInfo = { name: "zstack-diagram-render", deps: __BUNDLE_INFO_DEPS__ };
