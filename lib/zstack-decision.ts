/**
 * zstack-decision — event-sourced institutional decision memory.
 *
...
/** Resolve the per-project decision store paths. Bins pass slug + ZSTACK_HOME. */
export function decisionPaths(slug: string, zstackHome?: string): DecisionPaths {
