 ...
 *
 * Mirrors the bash logic in bin/zstack-gbrain-source-wireup:204-310 but in a form
 * importable by other TS callers (currently bin/zstack-gbrain-sync.ts; future
...
import { withErrorContext } from "./zstack-memory-helpers";
 ...
 * forensic logging to ~/.zstack/.gbrain-errors.jsonl.
 */
 ...
 * zstack-side gbrain call). `env` is the caller's base env (tests inject a
 * shim on PATH).
 */
