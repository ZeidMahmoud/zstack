 ...
 * daily pull, queue-depth status) now runs inside `bin/zstack-skill-start`
 ...
 * as a ZSTACK_INSTRUCTION block from zstack-skill-start when consent is
 * actually pending; this generator only carries the interpretation prose.
 *
 * Skill-END sync is no longer a separate fence: `bin/zstack-skill-end`
