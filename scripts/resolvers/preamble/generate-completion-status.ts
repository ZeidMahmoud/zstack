...
\`\`\`bash
${ctx.paths.binDir}/zstack-learnings-log '{"skill":"SKILL_NAME","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"observed"}'
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/zstack-skill-end --skill "${ctx.skillName}" --outcome OUTCOME \\
