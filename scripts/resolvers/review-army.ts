 ...
 * 1. Detect stack and scope (via zstack-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/zstack-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/zstack-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/zstack-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
