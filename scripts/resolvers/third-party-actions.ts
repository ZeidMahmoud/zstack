 ...
 * de-Aside'd it to drive only zstack's own stack. That stance was superseded
 ...
 * `aside --help`, never memorized here — and zstack never runs an installer.
 * zstack's own stack (browse headed mode + handoff/resume ($B), ZStack
