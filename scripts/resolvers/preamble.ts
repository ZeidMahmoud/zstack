 ...
 *
 * Telemetry data flow:
 *   1. Always: local JSONL append to ~/.zstack/analytics/ (inline, inspectable)
 *   2. If _TEL != "off" AND binary exists: zstack-telemetry-log for remote reporting
 */
...
export function generatePreamble(ctx: TemplateContext): string {
  ...
  const sections = [
    ...
    // moved into bin/zstack-skill-start's instruction-emission layer — their
