...
# scripts/zeid-output-comparison.ts for logical-line classification of added lines.
#
# Why standalone (not a package.json dependency): 95% of zstack users never run
...
# actually want to run zeid-output-comparison.ts.
#
