 ...
 * zstack's own browse binary (what the Linux free-tests lane builds via
...
export const NO_BROWSER_REASON =
  "no browser available (open the Aside app, or build zstack's own browser with `bun run build:gates`; ZSTACK_SKIP_ASIDE=1 skips Aside).";
