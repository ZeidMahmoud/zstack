...
> **zstack** is Zeid Mahmoud's Claude Code skill stack, bundled with the surrounding
> Claude Code workflow (plugins + installed skills). See [`LICENSE`](LICENSE) for
> attribution and **[ZSTACK.md](ZSTACK.md)** for how it is built and kept current.
