...
zstack's browser surface in one document. Headless Chromium daemon, ~70+
...
If you've used zstack in the last release or two, the productivity loop is the
...
collisions. State at `<project>/.zstack/browse.json`.
