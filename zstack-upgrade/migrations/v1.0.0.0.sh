...
# the older V0 prose can set `zstack-config set explain_level terse`.
#
...
PROMPTED_FLAG="$ZSTACK_HOME/.writing-style-prompted"
PENDING_FLAG="$ZSTACK_HOME/.writing-style-prompt-pending"
...
EXPLAIN_LEVEL_SET="$("${HOME}/.claude/skills/zstack/bin/zstack-config" get explain_level 2>/dev/null || true)"
