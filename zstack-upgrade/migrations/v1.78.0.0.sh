#!/usr/bin/env bash
# Migration: v1.78.0.0 — carry feature-discovery acknowledgements to ZSTACK_HOME
# (#2728 absorption follow-through).
#
# Why a migration: pre-v1.78, `zstack-skill-start` gated the one-time feature
...
# droppings in checkouts (#2728). v1.78 reads them from ZSTACK_HOME. Without
