/**
 * zstack browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__zstackInspectorActive) return;
  window.__zstackInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'zstack-inspector-highlight';
    ...
    tooltipEl.id = 'zstack-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'zstack-inspector-highlight' || target.id === 'zstack-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `zstack-inject-${id}`;
