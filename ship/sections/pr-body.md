...
and compute `NEW_TITLE=$(~/.claude/skills/zstack/bin/zstack-pr-title-rewrite.sh "$NEW_VERSION" "$CURRENT")`.
...
printf '%s' "$NEW_TITLE" | ~/.claude/skills/zstack/bin/zstack-redact --repo-visibility "$REDACT_VIS" --json
```
